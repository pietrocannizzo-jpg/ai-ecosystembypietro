...
export const categories: CategoryDef[] = [
  { id: "defence-startups", label: "Defence Tech Startups", color: "#f97316", side: "left" },
  { id: "defence-primes", label: "Defence Primes", color: "#f59e0b", side: "left" },
  { id: "space-satellite", label: "Space & Satellite", color: "#eab308", side: "left" },
  { id: "llm-chatbots", label: "LLM Chatbots", color: "#6366f1", side: "right" },
  { id: "coding-tools", label: "Coding Tools", color: "#06b6d4", side: "right" },
  { id: "image-gen", label: "Image Generation", color: "#d946ef", side: "right" },
...
export const defaultCards: CardData[] = [
  // === DEFENCE TECH STARTUPS ===
  {
    ...
    title: "Helsing",
    icon: "🇪🇺",
    category: "defence-startups",
    subcategory: "AI Defence",
    color: "#f97316",
    summary: "EU AI defence unicorn. Munich 2021. Valued at €14B+. Building autonomous combat systems including tactical drones, UCAV jets, and underwater systems.",
    tags: ["EU", "AI", "Drones", "Autonomous", "Unicorn"],
    links: [],
    subProducts: [
      { name: "HF-1 & HX-2", icon: "🛩️", description: "Tactical AI drones for ISR and strike" },
      { name: "CA-1 Europa UCAV", icon: "✈️", description: "Autonomous combat jet" },
      { name: "SG-1 Fathom", icon: "🤿", description: "Underwater autonomous drone" },
      { name: "Project Beyond", icon: "🧠", description: "AI fighter pilot system" },
    ],
    timeline: [
      { date: "2021", description: "Founded in Munich", type: "launch" },
      { date: "2023", description: "Series B funding, unicorn status", type: "funding" },
      { date: "2024", description: "Ukraine deployment of AI systems", type: "milestone" },
      { date: "2025", description: "Acquired Grob Aircraft", type: "milestone" },
      { date: "2025", description: "Blue Ocean Robotics acquisition", type: "milestone" },
      { date: "2025", description: "€14B+ valuation", type: "funding" },
      { date: "2026", description: "Estonia production facility launch", type: "launch" },
    ],
  ...
  },
  {
    ...
    color: "#f97316",
    summary: "Swiss aerospace. Pivoted from hypersonic hydrogen vehicles to defence UAVs. Acquired Daedalean AG for AI computer vision perception.",
    tags: ["Swiss", "Aerospace", "UAV", "AI Vision"],
    links: [],
    subProducts: [
      { name: "Daedalean AI Vision", icon: "👁️", description: "AI computer vision perception for autonomous flight" },
    ],
    timeline: [
      { date: "2021", description: "Founded", type: "launch" },
      { date: "2023", description: "First prototype flights", type: "milestone" },
      { date: "2024", description: "Pivot to defence", type: "update" },
      { date: "2025", description: "Acquired Daedalean AG (CHF 180M)", type: "milestone" },
    ],
    positionX: 0, positionY: 0,
  },
  {
    ...
    color: "#f97316",
    summary: "Palmer Luckey (Oculus founder), 2017. $30.5B valuation. Building autonomous weapons systems and the Lattice OS mesh network.",
    tags: ["US", "Autonomous", "AI", "Lattice", "Drones"],
    links: [],
    subProducts: [
      { name: "Lattice OS", icon: "🌐", description: "Autonomous AI mesh operating system" },
      { name: "Fury", icon: "✈️", description: "Autonomous jet drone" },
      { name: "Ghost Drones", icon: "👻", description: "Autonomous ISR/strike drones" },
      { name: "Arsenal-1", icon: "🏭", description: "$1B autonomous weapons factory" },
    ],
    timeline: [
      { date: "2017", description: "Founded by Palmer Luckey", type: "launch" },
      { date: "2022", description: "Lattice OS platform launch", type: "launch" },
      { date: "2024", description: "$22B IVAS contract", type: "funding" },
      { date: "2025", description: "Arsenal-1 factory announced", type: "milestone" },
      { date: "2026-02", description: "Successful drone flight switching Hivemind/Lattice with Shield AI", type: "milestone" },
    ],
    positionX: 0, positionY: 0,
  },
  {
    ...
    icon: "🇺🇸",
    category: "defence-startups",
    subcategory: "AI Pilot",
    color: "#f97316",
    summary: "AI pilot company. $5.6B valuation. Hivemind AI pilot software with autonomous swarm capability. Tested on F-16 fighters.",
    tags: ["US", "AI Pilot", "Swarm", "F-16", "Autonomous"],
    links: [],
    subProducts: [
      { name: "Hivemind", icon: "🧠", description: "AI pilot software — autonomous swarm, obstacle avoidance, formation flying" },
      { name: "V-BAT", icon: "🛩️", description: "Autonomous VTOL drone" },
    ],
    timeline: [
      { date: "2018", description: "Founded", type: "launch" },
      { date: "2024", description: "Hivemind tested on F-16", type: "milestone" },
      { date: "2025-12", description: "New CEO Gary Steele", type: "update" },
      { date: "2025", description: "Palantir Gaia integration", type: "milestone" },
      { date: "2026", description: "Seeking $200M additional funding", type: "funding" },
    ],
    positionX: 0, positionY: 0,
  },
  {
    ...
    color: "#f97316",
    summary: "Peter Thiel, 2003. NYSE:PLTR. Worth more than Lockheed Martin. AIP platform integrating LLMs on private data was a game changer.",
    tags: ["US", "NYSE:PLTR", "Data", "AI", "Military"],
    links: [],
    subProducts: [
      { name: "Gotham", icon: "🛡️", description: "Military intelligence platform" },
      { name: "Foundry", icon: "🏗️", description: "Commercial analytics platform" },
      { name: "AIP", icon: "🤖", description: "LLMs on private data (launched 2023)", releaseDate: "2023" },
      { name: "Gaia", icon: "🌍", description: "Simulation, training, deployment of autonomous systems" },
    ],
    timeline: [
      { date: "2003", description: "Founded by Peter Thiel", type: "launch" },
      { date: "2020", description: "Direct listing NYSE", type: "milestone" },
      { date: "2023", description: "AIP platform launched — game changer", type: "launch" },
      { date: "2025", description: "Gaia platform, Shield AI partnership", type: "milestone" },
      { date: "2025", description: "Market cap exceeds Lockheed Martin", type: "milestone" },
    ],
    positionX: 0, positionY: 0,
  },
  {
    ...
    icon: "🇩🇪",
    category: "defence-startups",
    subcategory: "ISR Drones",
    color: "#f97316",
    summary: "German ISR drones. ~€300M revenue 2025. Targeting €3B valuation.",
    tags: ["German", "ISR", "Drones"],
    links: [],
    subProducts: [],
    timeline: [
      { date: "2025", description: "~€300M revenue", type: "milestone" },
      { date: "2025", description: "Targeting €3B valuation", type: "funding" },
    ],
    positionX: 0, positionY: 0,
  },
  {
    ...
    icon: "🇩🇪",
    category: "defence-startups",
    subcategory: "Attack Drones",
    color: "#f97316",
    summary: "German attack drones. 3,900% headcount growth since 2024.",
    tags: ["German", "Attack Drones", "Growth"],
    links: [],
    subProducts: [],
    timeline: [
      { date: "2024-2025", description: "3,900% headcount growth", type: "milestone" },
    ],
    positionX: 0, positionY: 0,
  },
  {
    ...
    color: "#f97316",
    summary: "London. Autonomous systems middleware/software.",
    tags: ["UK", "Autonomous", "Middleware"],
    links: [],
    subProducts: [],
    timeline: [],
    positionX: 0, positionY: 0,
  },
  {
    ...
    icon: "🇳🇱",
    category: "defence-startups",
    subcategory: "Mission Autonomy",
    color: "#f97316",
    summary: "Amsterdam. Nexus platform — multi-domain distributed mission autonomy.",
    tags: ["Netherlands", "Mission Autonomy", "Multi-domain"],
    links: [],
    subProducts: [
      { name: "Nexus", icon: "🌐", description: "Multi-domain distributed mission autonomy platform" },
    ],
    timeline: [],
    positionX: 0, positionY: 0,
  },
  {
    ...
    subcategory: "C2",
    color: "#f97316",
    summary: "Paris. Prevail platform — AI command & control.",
    tags: ["France", "C2", "AI"],
    links: [],
    subProducts: [
      { name: "Prevail", icon: "🎯", description: "AI command & control platform" },
    ],
    timeline: [],
    positionX: 0, positionY: 0,
  },
  ...
  // === DEFENCE PRIMES ===
  {
    ...
    title: "Leonardo",
    icon: "🇮🇹",
    category: "defence-primes",
    subcategory: "Italian Prime",
    color: "#f59e0b",
    summary: "Italian prime. €19.5B revenue. ~53K employees. GCAP 6th-gen fighter with UK & Japan. Acquired Iveco Defence Vehicles €1.7B.",
    tags: ["Italy", "GCAP", "Fighter", "Prime"],
    links: [],
    subProducts: [],
    timeline: [
      { date: "2025", description: "Acquired Iveco Defence Vehicles €1.7B", type: "milestone" },
      { date: "2025", description: "GCAP programme advancing with UK & Japan", type: "update" },
    ],
    positionX: 0, positionY: 0,
  },
  {
    ...
    icon: "🇺🇸",
    category: "defence-primes",
    subcategory: "US Prime",
    color: "#f59e0b",
    summary: "World's #1 defence contractor. ~$71B revenue. F-35, THAAD, Aegis. JADC2 AI integration.",
    tags: ["US", "F-35", "#1 Defence", "JADC2"],
    links: [],
    subProducts: [],
    timeline: [],
    positionX: 0, positionY: 0,
  },
  {
    ...
    icon: "🇬🇧",
    category: "defence-primes",
    subcategory: "UK Prime",
    color: "#f59e0b",
    summary: "UK prime. ~$30B+ revenue. Tempest/GCAP fighter programme. $1.2B Epoch 2 satellite contract.",
    tags: ["UK", "GCAP", "Tempest", "EW"],
    links: [],
    subProducts: [],
    timeline: [
      { date: "2025", description: "$1.2B Epoch 2 satellite contract", type: "funding" },
    ],
    positionX: 0, positionY: 0,
  },
  {
    ...
    icon: "🇩🇪",
    category: "defence-primes",
    subcategory: "German Prime",
    color: "#f59e0b",
    summary: "German. Major EU rearmament beneficiary. Lynx IFV, Panther KF51. Revenue surging on €500B+ defence spending wave.",
    tags: ["German", "Rearmament", "Lynx", "KF51"],
    links: [],
    subProducts: [],
    timeline: [],
    positionX: 0, positionY: 0,
  },
  {
    ...
    subcategory: "US Prime",
    color: "#f59e0b",
    summary: "~$75B revenue. Patriot, NASAMS air defence. AI in targeting & sensors.",
    tags: ["US", "Patriot", "Air Defence"],
    links: [],
    subProducts: [],
    timeline: [],
    positionX: 0, positionY: 0,
  },
  {
    ...
    subcategory: "US Prime",
    color: "#f59e0b",
    summary: "~$40B revenue. B-21 Raider stealth bomber. JADC2 integration. Space systems.",
    tags: ["US", "B-21", "Stealth", "Space"],
    links: [],
    subProducts: [],
    timeline: [],
    positionX: 0, positionY: 0,
  },
  {
    ...
    icon: "🇫🇷",
    category: "defence-primes",
    subcategory: "French Prime",
    color: "#f59e0b",
    summary: "French. AI air traffic management. Cyber & digital security. Ground Master radars.",
    tags: ["France", "Cyber", "Radar", "ATM"],
    links: [],
    subProducts: [],
    timeline: [],
    positionX: 0, positionY: 0,
  ...
  // === SPACE & SATELLITE ===
  {
    ...
    subcategory: "Military Space",
    color: "#eab308",
    summary: "Starlink for military. Starshield: encrypted, anti-jam. MILNET ~480 military sats. 15,000 Gen2 approved.",
    tags: ["Space", "Starlink", "Military", "Satellites"],
    links: [],
    subProducts: [
      { name: "Starshield", icon: "🛡️", description: "Encrypted, anti-jam military satellite network" },
      { name: "MILNET", icon: "📡", description: "~480 military satellites" },
    ],
    timeline: [
      { date: "2025", description: "15,000 Gen2 satellites approved", type: "milestone" },
      { date: "2026", description: "V3 sats via Starship", type: "launch" },
    ],
    positionX: 0, positionY: 0,
  },
  {
    id: "defence-sat-jv",
    title: "Helsing/HENSOLDT/Kongsberg JV",
    icon: "🛰️",
    category: "space-satellite",
    subcategory: "Defence Constellation",
    color: "#eab308",
    summary: "Joint venture building 75-100 defence satellite constellation.",
    tags: ["EU", "Satellites", "Constellation"],
    links: [],
    subProducts: [],
    timeline: [],
    positionX: 0, positionY: 0,
  },
  {
    ...
    color: "#eab308",
    summary: "3,000 satellite network. 2025-2026 deployment. Potential defence applications.",
    tags: ["Amazon", "Satellites", "Broadband"],
    links: [],
    subProducts: [],
    timeline: [
      { date: "2025-2026", description: "Deployment phase", type: "launch" },
    ],
    positionX: 0, positionY: 0,
  },
