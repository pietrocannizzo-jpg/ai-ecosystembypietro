...
export const cards: CardData[] = [
  ...
  },
  {
    ...
    subcategory: "AI IDE",
    color: "#4285f4",
    summary: "Google's cloud-native AI IDE powered by Gemini 3. Full-stack development environment with $2.4B infrastructure investment. Competes with Cursor, Windsurf, and Claude Code.",
    pricing: "freemium",
    price: "Free / $19-49/mo",
    bestFor: "Cloud-native AI-powered development",
    modelUsed: "Gemini 3",
    quickstart: "https://antigravity.dev",
    tags: ["Google", "AI IDE", "Gemini", "Cloud-native", "Full-stack"],
    links: ["https://antigravity.dev"],
    subProducts: [
      { name: "Antigravity IDE", icon: "🖥️", description: "Cloud-native AI development environment built on Gemini 3" },
      { name: "Stitch Integration", icon: "🎨", description: "Design-first workflow with Google Stitch for UI-to-code" },
    ],
    timeline: [
      { date: "2025-12", description: "Antigravity announced at Google I/O Winter", type: "launch" },
      { date: "2026-01", description: "Public beta with Gemini 3 integration", type: "launch" },
      { date: "2026-02", description: "Stitch design-to-code workflow added", type: "product" },
    ],
    positionX: 620,
    positionY: 1467,
  },
