  ...
  return (
    <div>
      ...
      <section className="relative pt-20 sm:pt-28 pb-0 px-4 sm:px-6 overflow-hidden dark-zone">
        ...
        {/* Gradient: dark fading into cream — overlaps bottom of dark section */}
        <div className="absolute bottom-0 left-0 right-0 h-56 bg-gradient-to-b from-transparent to-background z-20 pointer-events-none" />
      </section>
